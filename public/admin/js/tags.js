          ...
          case 8:
            if (doGetCaretPosition($input[0]) === 0) {
              ...
              if (prev.length) {
                ...
                // <<<<< TRP 12/27/15
                if (typeof prev_item === 'string' && prev_item == $input.val() || (typeof prev_item === 'undefined' ? 'undefined' : _typeof(prev_item)) === 'object' && prev_item.name == $input.val()) {
        ...
        if (self.options.freeInput && (keyCombinationInList(event, self.options.confirmKeys) || maxLengthReached)) {
          ...
          if (text.length !== 0) {
            ...
            if (self.objectItems) {
              ...
              if (beforeFreeInputItemAdd.cancel) return;
